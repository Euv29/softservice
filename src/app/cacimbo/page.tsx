        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <p className="text-sm text-gray-500 mb-4">Confiança garantida pelos melhores no mercado</p>
                <div className="flex items-center space-x-6 opacity-60">
                  {/* Placeholder for logos - replace with actual client logos */}
                  <div className="w-16 h-8 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">Logo 1</div>
                  <div className="w-16 h-8 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">Logo 2</div>
                  <div className="w-16 h-8 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">Logo 3</div>
                  <div className="w-16 h-8 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">Logo 4</div>
                  <div className="w-16 h-8 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">Logo 6</div>
                  <div className="w-16 h-8 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">Logo 7</div>
                </div>
              </motion.div>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl p-12 text-center border border-gray-200">
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Mapa CACIMBO</h4>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <motion.a
                href="/contactos"
                className="group inline-flex items-center justify-center px-10 py-4 bg-white text-[#e7003b] font-semibold rounded-2xl hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 min-w-[200px]"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
              >
              ...
              <motion.a
                ...
                className="group inline-flex items-center justify-center px-10 py-4 border-2 border-white/50 text-white font-semibold rounded-2xl hover:bg-white hover:text-[#e7003b] transition-all duration-300 backdrop-blur-sm hover:border-white transform hover:scale-105 min-w-[200px]"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
              >
                <svg className="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
